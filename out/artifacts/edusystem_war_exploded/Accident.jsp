...
<link href="css/Accident.css" type="text/css" rel="stylesheet" />

<title>对不起由于您上学期发生教学事故本学期不可申请教学计划</title>
</head>

<!-- 对不起由于您上学期发生教学事故本学期不可申请教学计划 -->
...
<div class="contenter">
    <div class="main">
    	<div class="box">
                <p>对不起由于您上学期发生教学事故本学期不可申请教学计划!</p>
                <br/>
                <br/>
          <div class="enter_form clear">
          <a href="AddCoursePlan.jsp" class="e_back"></a>
          </div>
        </div>
