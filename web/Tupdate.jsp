...
<link href="css/Tupdate.css" type="text/css" rel="stylesheet" />
...
<div class="contenter">
    <div class="main">
    	<div class="box">
            <form action="/TUpdateServlet" method="post">
            	...
            	<div class="r_words float_left">
                    ...
                    <li><input type="submit" value="修改"  style=" color:black; width:80px;background:#d0d0d0;"/></li>
                    </ul>
              </div>
          </form>
        </div>
